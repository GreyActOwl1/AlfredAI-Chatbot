...
export default function DocsPage() {
	const [chats, setChats] = useState<
		{ name: string; multiMessages: Message[] }[]
	>([]);
	const [chatName, setChatName] = useState("");
	const { isOpen, onOpen, onOpenChange } = useDisclosure();
	...
	return (
		<div className="flex flex-col gap-y-6 mt-20 bg-white min-h-screen dark:bg-black">
			<h1 className={title()}>
				{" "}
				<span className="flex justify-center mb-6 text-black dark:text-white">
					Chat
				</span>
			</h1>{" "}
			<Modal
